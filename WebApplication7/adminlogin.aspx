<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeFile="adminlogin.aspx.cs" Inherits="WebApplication7.adminlogin" %>
...
@keyframes wrong-log {
  ...
  40% , 80% {
    ...
    </style><center>  <h1 style="font-size: xx-large; color: #2F878E"><B>Admin Login</B></h1>
