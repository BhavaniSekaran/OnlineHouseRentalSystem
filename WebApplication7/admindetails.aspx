<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="admindetails.aspx.cs" Inherits="WebApplication7.admindetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>  <h1 style="font-size: xx-large; color: #2F878E"><B>&nbsp;SELLER DETAILS</B></h1>
   ...
   <ItemTemplate>
         ...
         <table>
                                     ...
                                     <tr>
                                         <td><b>Name:</b></td>
                                         <td>
                                             <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="12pt" ForeColor="#000066" Text='<%# Eval("name") %>' Width="100%" />
                                             <br />
                                         </td>
                                     </tr>
                                     <tr>
