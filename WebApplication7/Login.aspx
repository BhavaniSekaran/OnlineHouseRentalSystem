<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="WebApplication7.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<div>  <center>  <h1 style="font-size: xx-large; color: #2F878E"><B>&nbsp;Customer Login</B></h1>
        </div>
