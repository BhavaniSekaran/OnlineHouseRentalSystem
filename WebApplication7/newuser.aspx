<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeFile="newuser.aspx.cs" Inherits="WebApplication7.newuser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="form-row">
        ...
        <asp:Calendar ID="Calendar1" runat="server"></asp:Calendar>
                                     ...
                                     <div>
                                         <asp:Label ID="Label1" runat="server" style="font-family: Arial; font-weight: bold; font-size: medium"></asp:Label>
                                         <br />
                                         <br />
                                         <br />
                                         <br />
                                         <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click1">Back To Login</asp:LinkButton>
                                     </div>
                          </div>
